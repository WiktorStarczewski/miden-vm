...
| adv.insert_bcompress                         | [BLOCK_LO, BLOCK_HI, CV, ...] | [BLOCK_LO, BLOCK_HI, CV, ...] | Reads the top 12 elements, computes $K \leftarrow BlakeG(BLOCK_LO, BLOCK_HI, CV)$, and saves $advice\_map[K] \leftarrow [BLOCK_LO, BLOCK_HI]$. |
...
| mem_stream <br /> - _(1 cycle)_                                                      | [A, B, C, a, ... ]  | [D, E, C, a', ... ] | $[D, E] \leftarrow [mem[a..(a+4)], mem[(a+4)..(a+8)]]$ <br /> $a' \leftarrow a + 8$ <br /> Reads two sequential words from memory starting at address $a$, replacing the block words while preserving the BlakeG chaining word.                                                                                                                                                                      |
